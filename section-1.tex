...
\begin{remarks}\hfill
    \begin{enumerate}
        \item For a linear mapping \( A \) and an arbitrary \( y = th \in \Rn \) it is
              \[
                  \frac{\|Ay\|}{\|y\|} = \frac{\|Ah\|}{\|h\|}
              \]
              Hence
              \[
                  \frac{\|Ay - By\|}{\|y\|} = \frac{\|Ah - Bh\|}{\|h\|}\le
        ...
        \item As a consequence, if already \( f(x + h) - f(x) - Ah = 0 \) then \( Df(x) = A \).
              Hence \( Df(x) = 0 \) for \( f = const \) and \( f(x) = Ax \) gives \( Df(x) = A \).
...
\begin{definition}
    ...
    \begin{enumerate}
        \item For \( x \in \Omega \) and \( d \in \Rn \) assume the limit
              \[
                  \frac{\partial f}{\partial d}(x) = \lim_{t \to 0} \frac{f(x + td) - f(x)}{t}
              \]
              exists. Then this called the \emph{directional derivative} of \( f \) at \( x \)
