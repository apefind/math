...
\begin{lemma}[Cauchy-Schwarz Inequality]\label{thm:cauchy_schwarz_inequality}
...
\begin{proof}
    ...
    % \( xy > 0 \) implies \( \lambda > 0 \)
\end{proof}
\bigskip

\begin{lemma}[Triangle Inequality]\label{thm:triangle_inequality}
    For \( x, y \in \Rn \) the following inequality holds
    \[
        \|x + y\| \le \|x\| + \|y\|
    \] 
