...
\begin{remark}
    ...
    \]
    % Hence \( \partial_x f(x, 0) = 0 \) and \( \partial_y f(0, y) = 0 \) and thus \( \gradient f(0,0) = (0, 0) \).
    For \( (x,y) \ne (0,0) \) it is
    \[
        \partial_{xy} f(x,y) = \partial_{yx} f(x,y) =
        \frac{y^{2} \left(- 3 x^{4} + 6 x^{2} y^{2} + y^{4}\right)}{{(x^2 + y^2)}^4}
    \]
    Hence \( \partial_{xy}f(x,0) = 0 \) and  \( \partial_{yx}f(0,y) = 1 \).
\end{remark}
\bigskip
...
\begin{remark}
    ...
    \]
    % \[
    %     \frac{\partial f}{\partial x}(x,y) = \frac{-2xy^3}{{(x^2 + y^2)}^2} \spacedtext{and}
