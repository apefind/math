...
\begin{remarks}
    \hfill
    \begin{enumerate}
        \item Let \( f: \Rn \to \R \) and \( g(x) = f(x|^2 \). The multidemnsional  chain rule yields
            \[ 
        ...
        \] 
        \item More genearally Let \( f = (f_1, f_2, \dots f_n) : \Rn \to \Rm \) and 
            \[ 
...
\subsection{Feedforward Neural Networks and the Univeral Approximation Theorem}
