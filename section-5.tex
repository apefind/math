...
\end{algorithm}
\inputminted[fontsize=\small, framesep=0.35cm, frame=lines, python3=true]{python}{notebook/weight.py}
\bigskip
...
\end{algorithm}
\inputminted[fontsize=\small, framesep=0.35cm, frame=lines, python3=true]{python}{notebook/perceptron.py}
\bigskip
...
\inputminted[fontsize=\small, framesep=0.35cm, frame=lines, python3=true]{python}{notebook/delta_rule.py}
\bigskip
