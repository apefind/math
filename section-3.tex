...
\]  
if at least one of the series is absolutely convergent. Henve
\[
    \begin{split}
		\sum_{n=0}^\infty \frac{1}{n!} a^n \sum_{n=0}^\infty \frac{1}{n!} b^n 
			& = \sum_{n=0}^{\infty } \sum_{k=0}^{n} \frac{1}{k!} a^{k} \frac{1}{(n - k)!} b^{n - k} \\
